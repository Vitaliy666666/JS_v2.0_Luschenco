...
function f5(){
   //const button = document.querySelector('.b-5')
   let sum = +document.querySelector('.i-5').value;
...
function f6(){
   let sum = document.querySelector('.i-6').value;
...
function f7(){
   let sumA = +document.querySelector('.i-71').value;
   let sumB = +document.querySelector('.i-72').value;
   let out = document.querySelector('.out-7');
   out.innerHTML = Math.pow(sumA, sumB);
}
...
function f15(){
   let sA = +document.querySelector('.s-151').value;
   let sB = +document.querySelector('.s-152').value;
   let selC = document.querySelector('.s-153').value;

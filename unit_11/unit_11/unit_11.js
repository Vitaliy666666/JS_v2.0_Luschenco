...
function f11() {
    let r = +document.querySelector('.i-11').value;
    document.querySelector('.out-11').innerHTML = d11.indexOf(r);
...
function f15() {
    ...
    if(d15.indexOf(inp) === - 1){
        document.querySelector('.out-12').innerHTML = d15.push(inp)
    }
    showArr('.out-15', d15);
}
...
function f18() {
    let s = document.querySelector('.i-18').value;
    let out = '';
    out = d18.includes(s);
